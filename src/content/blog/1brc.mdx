...
```sh
Time (mean ± σ):     35.425 s ±  0.435 s    [User: 106.103 s, System: 12.649 s]
Range (min … max):   34.646 s … 36.355 s    10 runs
```
...
```sh
Time (mean ± σ):     34.366 s ±  0.347 s    [User: 101.961 s, System: 13.093 s]
Range (min … max):   33.734 s … 34.677 s    10 runs
```
