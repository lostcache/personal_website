...
class FastMap {
  ...
  public:
    ...
    bool update(std::string_view location, int32_t temperature) {
...
```sh
Time (mean ± σ):     32.159 s ±  0.117 s    [User: 70.174 s, System: 12.352 s]
Range (min … max):   32.056 s … 32.436 s    10 runs
```
