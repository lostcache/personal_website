---
title: "The 1🐝🏎️ Challenge in Zig and Rust"
...
because of page faults. But this is my machine with just 16 GB of RAM (i'm poor) and the mmap will almost certainly be faster with more memory available.
