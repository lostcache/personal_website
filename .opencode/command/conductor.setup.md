...
> **Conductor Source:** [setup.toml](https://github.com/gemini-cli-extensions/conductor/blob/32f44820450576e60a0685de602fff38bfd85609/commands/conductor/setup.toml)
> **Local Reference:** `/Users/harsh_devisha/.opencode/conductor-bridge/vendor/conductor/commands/conductor/setup.toml`
...
2.  **Select Code Style Guides:**
    -   List the available style guides by running `ls /Users/harsh_devisha/.opencode/conductor-bridge/vendor/conductor/templates/code_styleguides/`.
    ...
    -   **Action:** Construct and execute a command to create the directory and copy all selected files. For example: `mkdir -p conductor/code_styleguides && cp /Users/harsh_devisha/.opencode/conductor-bridge/vendor/conductor/templates/code_styleguides/python.md /Users/harsh_devisha/.opencode/conductor-bridge/vendor/conductor/templates/code_styleguides/javascript.md conductor/code_styleguides/`
...
1.  **Copy Initial Workflow:**
    -   Copy `/Users/harsh_devisha/.opencode/conductor-bridge/vendor/conductor/templates/workflow.md` to `conductor/workflow.md`.
